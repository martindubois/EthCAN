...
typedef enum
{
    ...
    EthCAN_ERROR_INPUT_STREAM_READ,         // 270
    ...
    EthCAN_ERROR_OUTPUT_FILE_OPEN,          // 280
    ...
    EthCAN_ERROR_THREAD,
    EthCAN_ERROR_TIMEOUT,                   // 300

    EthCAN_ERROR_QTY,

    EthCAN_RESULT_INVALID = 0x7ff0,
