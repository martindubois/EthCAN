...
mkdir Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/bin
mkdir Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/inc
mkdir Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/lib

cp _DocUser/EthCAN.ReadMe.txt                         Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION
cp Binaries/EthCAN_Tool                               Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/bin
...
cp Import/Libraries/KmsLib.a                          Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/lib
cp Includes/*.h                                       Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/inc
cp Libraries/EthCAN_Lib.a                             Packages/$PACKAGE_NAME/usr/local/EthCAN-$VERSION/lib
